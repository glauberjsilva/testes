...
public class CalculadoraMockSpy {
	...
	public void devoMostrarDiferencaEntreMockSpy3() {
		...
		Mockito.doNothing().when(calcSpy).imprime(); // Não executa o método imprime com assinatura
				
		System.out.println("Mock");
		calcMock.imprime(); // Retorna o valor padrão do método, como é void não retorna nada
		System.out.println("Spy");
		calcSpy.imprime(); //Ao utilizar a expectativa Mockito.doNothing o método imprime() assinatura void não é executado
	}
}
